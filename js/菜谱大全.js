...
var twelve = document.getElementById('content12');
	twelve.onmouseover = function(){
		twelve.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	twelve.onmouseout = function(){
		twelve.setAttribute("style","top:0px;transition:top 500ms;");
	}

var thirteen = document.getElementById('content13');
	thirteen.onmouseover = function(){
		thirteen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	thirteen.onmouseout = function(){
		thirteen.setAttribute("style","top:0px;transition:top 500ms;");
	}

var fourteen = document.getElementById('content14');
	fourteen.onmouseover = function(){
		fourteen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	fourteen.onmouseout = function(){
		fourteen.setAttribute("style","top:0px;transition:top 500ms;");
	}

var fifteen = document.getElementById('content15');
	fifteen.onmouseover = function(){
		fifteen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	fifteen.onmouseout = function(){
		fifteen.setAttribute("style","top:0px;transition:top 500ms;");
	}

var sixteen = document.getElementById('content16');
	sixteen.onmouseover = function(){
		sixteen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	sixteen.onmouseout = function(){
		sixteen.setAttribute("style","top:0px;transition:top 500ms;");
	}

var seventeen = document.getElementById('content17');
	seventeen.onmouseover = function(){
		seventeen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	seventeen.onmouseout = function(){
		seventeen.setAttribute("style","top:0px;transition:top 500ms;");
	}

var eighteen = document.getElementById('content18');
	eighteen.onmouseover = function(){
		eighteen.setAttribute("style","top:-100px;transition:top 500ms;");
	}
	eighteen.onmouseout = function(){
		eighteen.setAttribute("style","top:0px;transition:top 500ms;");
	}
$.fn.extend({
...
$(".blacktwo").click(function(){
	$("#section_three").css("display","none");
	$(".leftsidebar_box").css("display","block");
})
$(".redtwo").click(function(){
	$("#section_three").css("display","block");
	$(".leftsidebar_box").css("display","none");
})